...
גרסה 1.5 · מבוססת PHP + MySQL · להתקנה על שרת cPanel
...
## היסטוריית גרסאות
- **1.5** — מודול הצעות מחיר והזמנות: קטלוג שירותים, בונה הצעה, מע"מ, PDF/מסך לקוח, חתימה דיגיטלית, ומסך הגדרות לחיבור GREEN API.
