...
function nav_icon($name) {
    $icons = [
        ...
        'quotes'    => '<path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/>',
...
<div class="layout">
  <aside class="sidebar">
    ...
    <nav class="nav">
      ...
      <a href="quotes.php" class="<?= in_array($active,['quotes','quote_services'])?'active':'' ?>"><?= nav_icon('quotes') ?><span class="t">הצעות מחיר</span></a>
      <a href="admins.php" class="<?= $active==='admins'?'active':'' ?>"><?= nav_icon('admins') ?><span class="t">מנהלים</span></a>
      <a href="settings.php" class="<?= $active==='settings'?'active':'' ?>"><?= nav_icon('settings') ?><span class="t">הגדרות</span></a>
    </nav>
    <div class="side-foot">
